...
const MediaViewer = ({ resource }: { resource: CloudinaryResource }) => {
  ...
  switch (filter) {
    ...
    case "cartoonify":
      transformations.cartoonify = true;
      break;

    case "vignette":
      transformations.vignette = true;
      break;

    case "pixelate":
      transformations.pixelate = true;
      break;
            ...
            <TabsContent value="filters">
              ...
              <ul className="grid grid-cols-2 gap-2">
                ...
                <li>
                  <button
                    className={`w-full border-4 ${
                      filter === "frost" ? "border-white" : "border-transparent"
                    }`}
